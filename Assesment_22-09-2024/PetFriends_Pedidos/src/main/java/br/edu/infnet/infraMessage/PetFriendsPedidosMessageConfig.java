package br.edu.infnet.infraMessage;

import br.edu.infnet.eventos.EstadoPedidoMudou;
import br.edu.infnet.messageDeserializer.EstadoPedidoMudouDeserializer;
import br.edu.infnet.messageSerializer.EstadoPedidoMudouSerializer;
...
public class PetFriendsPedidosMessageConfig {
    ...
    public PubSubInboundChannelAdapter inboundChannelAdapter(
        ...
        PubSubInboundChannelAdapter adapter = new PubSubInboundChannelAdapter(pubSubTemplate, "topic-pedidos-sub");
